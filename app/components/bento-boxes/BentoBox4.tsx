...
export default function BentoBox4() {
  return (
    <div className="h-[28vh] w-full rounded-2xl bg-gradient-to-br from-[#D6ECFF] via-[#27AAE1] to-[#00378A] flex flex-col relative p-6 md:p-8">
      ...
      <div className="flex-1 flex flex-col justify-center mt-10 sm:mt-8 md:mt-0 lg:mt-16 px-2 sm:px-0">
        <div className="flex flex-col gap-2 sm:gap-3 md:gap-1 lg:gap-4">
          ...
          <h2 className="text-white text-5xl md:text-5xl  lg:text-xl xl:text-6xl 2xl:text-7xl font-light leading-tight tracking-tighter break-words">
            20+ Industries
          </h2>
        </div>
      </div>
