...
export default function BentoBox2() {
  return (
    <div className="max-h-[520px] w-full rounded-2xl bg-gradient-to-tr from-[#F3F3F3] via-white to-[#00A9EE] relative overflow-hidden">
      <div className="relative flex flex-col size-full max-w-4xl overflow-hidden pt-6 md:pt-9 pb-40 md:pb-60 px-6 md:px-9">
        <p className="text-[#242424] text-base md:text-3xl font-light mb-4">
