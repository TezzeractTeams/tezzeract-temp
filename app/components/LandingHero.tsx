        ...
        <div className="flex flex-row gap-4 relative z-10">
          <div className="flex flex-col gap-0 md:gap-3 lg:gap-4 w-full md:w-[60%] md:pt-0 pt-26">
            ...
            <Link href="/get-started" className="self-center md:self-start cursor-pointer transition-transform duration-200">
              <TezzeractButtonLight className="w-[200px] md:w-[280px] lg:w-[300px] text-sm md:text-base cursor-pointer">Get started with a vetting expert</TezzeractButtonLight>
            </Link>
          </div>
